...
public class ProteinOntologyImport {
    ...
    * */
    ...
    public static void main(String[] args) throws java.io.IOException {
        try (DBCursor dbCursor = getCollection(ImportCollectionNames.PROTEIN_ONTOLOGY).findDBCursor("{}")) {
    ...
    public static void getPubmedFromSynonymList(BasicDBObject dbObj, List<String> pList) {
        BasicDBList list = OntologyStrUtil.getList(dbObj, ProteinOntologyFields.SYNONYM_LIST);
     ...
     * @throws Exception
     */
    public static void createPubMedRelationship(ProteinOntology prOnto, BasicDBObject dbObj, Subgraph subGraph) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException, NotFoundException, InvocationTargetException, URISyntaxException, IOException, HttpException, InterruptedException {
     ...
     * @param pList
     */
    public static void extractProteinForDisjoint(String str, List<String> pList) {
    ...
    public static List<String> getDisjointFromList(BasicDBObject dbObj) {
        List<String> pList = new ArrayList<>();
        BasicDBList list = OntologyStrUtil.getList(dbObj, ProteinOntologyFields.DISJOINT_FROM_LIST);
        for (Object obj : list) {
     ...
     * @throws Exception
     */
    public static void setIsARelationship(ProteinOntology prOnto, BasicDBObject dbObj, Subgraph subGraph) throws NoSuchFieldException, IllegalAccessException, InvocationTargetException, IOException, RuntimeException, InterruptedException, HttpException, URISyntaxException {
        if (OntologyStrUtil.listExists(dbObj, ProteinOntologyFields.IS_LIST)) {
            //log.info("createIsARelationships()");
            BasicDBList list = OntologyStrUtil.getList(dbObj, ProteinOntologyFields.IS_LIST);
            for (Object obj : list) {
     ...
     * @throws Exception
     */
    public static void setGoIsARelationship(String str, ProteinOntology prOnto, Subgraph subGraph, BioRelTypes relType) throws IOException, RuntimeException, IllegalAccessException, InterruptedException, HttpException, URISyntaxException, InvocationTargetException, NoSuchFieldException {
...
*/
     ...
     */
    public static void setRelationshipList(ProteinOntology prOnto, BasicDBObject dbObj, Subgraph subGraph) throws NotFoundException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, UnknownHostException {
        if (OntologyStrUtil.listExists(dbObj, ProteinOntologyFields.RELATIONSHIP_LIST)) {
            //log.info("createIsARelationship()");
            BasicDBList list = OntologyStrUtil.getList(dbObj, ProteinOntologyFields.RELATIONSHIP_LIST);
            for (Object obj : list) {
    ...
    public static NcbiTaxonomy getNcbiTaxon(String str, Subgraph subGraph) throws InvocationTargetException, NoSuchFieldException, IllegalAccessException, UnknownHostException {
     ...
     * @param str
     */
    public static void setNcbiTaxonRelationship(ProteinOntology prOnto, Subgraph subGraph, String str) throws UnknownHostException, NoSuchFieldException, IllegalAccessException, InvocationTargetException {
     ...
     * @throws Exception
     */
    public static void setNcbiTaxonIntersectionRelationship(ProteinOntology prOnto, Subgraph subGraph, String str) throws UnknownHostException, NoSuchFieldException, IllegalAccessException, InvocationTargetException {
        getRelationshipType(str, OntologyStrUtil.NCBITaxonPattern);
        NcbiTaxonomy ncbiTaxOn = getNcbiTaxon(str, subGraph);
        if (ncbiTaxOn != null) {
     ...
     */
    public static void setIntersectionList(ProteinOntology prOnto, BasicDBObject dbObj, Subgraph subGraph) throws NotFoundException, NoSuchFieldException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, UnknownHostException {
        if (OntologyStrUtil.listExists(dbObj, ProteinOntologyFields.INTERSECTION_OF_LIST)) {
            //log.info("createIsARelationship()");
            BasicDBList list = OntologyStrUtil.getList(dbObj, ProteinOntologyFields.INTERSECTION_OF_LIST);
            for (Object obj : list) {
    ...
    public static void setConsiderRelationship(ProteinOntology prOnto, BasicDBObject dbObj, Subgraph subGraph) throws NoSuchFieldException, IllegalArgumentException, IllegalAccessException, NotFoundException, InvocationTargetException, URISyntaxException, UnknownHostException {
        if (OntologyStrUtil.listExists(dbObj, ProteinOntologyFields.CONSIDER_LIST)) {
            BasicDBList list = OntologyStrUtil.getList(dbObj, ProteinOntologyFields.CONSIDER_LIST);
            for (Object obj : list) {
     ...
     * @throws Exception
     */
    public static void processProteinOntology(String ontologyId, BasicDBObject obj) throws NoSuchFieldException, IllegalAccessException, InvocationTargetException, IOException, RuntimeException, InterruptedException, HttpException, URISyntaxException {
