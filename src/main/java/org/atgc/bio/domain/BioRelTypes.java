...
public enum BioRelTypes {
    ...
    // CYP450 - drug to enzyme relationship
    OXIDATIVE_METABOLISM("OXIDATIVE_METABOLISM"),
    ...
    CURATED("CURATED_AUTOMATIC_ASSERTION"),
    NON_TRACEABLE_AUTHOR_STATEMENT("NON_TRACEABLE_AUTHOR_STATEMENT"),
    CURATED_LITERATURE_REFERENCE("CURATED_LITERATURE_REFERENCE"),

    /* drug */
    REFERENCES_PATENT("REFERENCES_PATENT"),
    DRUG_INTERACTS_WITH("DRUG_INTERACTS_WITH"),
    IDENTIFIED_PROTEIN("IDENTIFIED_PROTEIN"),
    PROTEIN_ASSOCIATED_WITH_DISEASE("PROTEIN_ASSOCIATED_WITH_DISEASE"),
    INHIBITS("INHIBITS");
