...
public enum NciGeneRoles {
    ...
    */
    ...
    private static final Map<String, NciGeneRoles> stringToEnum = new HashMap<String, NciGeneRoles>();

    static { // init map from constant name to enum constant
        for (NciGeneRoles en : values())
            stringToEnum.put(en.toString(), en);
    }

    public boolean equals(NciGeneRoles bioType) {
    ...
    public static NciGeneRoles fromString(String value) {
    ...
    public static NciGeneRoles getRoleEnum(String prefixVal) {
        for (String value : stringToEnum.keySet()) {
