 ...
 * @author jtanisha-ee
 */
@UniqueCompoundIndex(indexName=IndexNames.EXPERIMENTAL_PROPERTY, field1=BioFields.CHEMICAL_ABSTRACT_ID, field2=BioFields.KIND, field3=BioFields.SOURCE)
...
public class ExperimentalProperty {
    ...
    */
    ...
    private String nodeType = BioTypes.EXPERIMENTAL_PROPERTY.toString();

    @NodeLabel
    @Indexed (indexName=IndexNames.EXPERIMENTAL_PROPERTY_MESSAGE)
    @Taxonomy (rbClass=TaxonomyTypes.EXPERIMENTAL_PROPERTY_MESSAGE, rbField=BioFields.MESSAGE)
    ...
    /**
     * Get the type of experimental property. For instance. Log P.
     * 
     * @return String 
     */
    ...
    /**
     * Set the type of experimental property.
     * 
     * @param kind 
     */
    ...
    /**
     * Get the value of the experimental property.
     * 
     * @return String 
     */
    ...
    /**
     * Set the value of the experimental property.
     * 
     * @param value 
     */
    ...
    /**
     * Get the source of the experimental property.
     * 
     * @return String 
     */
    ...
    /**
     * Set the source of the experimental property.
     * 
     * @param source 
     */
