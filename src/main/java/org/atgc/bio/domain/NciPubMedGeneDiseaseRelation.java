 ...
 */
@RelationshipEntity
public class NciPubMedGeneDiseaseRelation {

    protected static Logger log = LogManager.getLogger(NciPubMedGeneDiseaseRelation.class);
     ...
     */
    @RelType
    private String relType = BioRelTypes.REFERENCES_PUBMED.toString();
    ...
    */
    ...
    public NciPubMedGeneDiseaseRelation(){};

    public void setNciPubMedGeneDiseaseRelation(Object startNode, Object endNode,
                BioRelTypes relType) {
