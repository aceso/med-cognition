...
public enum UniProtEvidenceFields {
    ...
    */
    ...
    private static final Map<String, UniProtEvidenceFields> stringToEnum = new HashMap<String, UniProtEvidenceFields>();

    static { // init map from constant name to enum constant
        for (UniProtEvidenceFields en : values())
            stringToEnum.put(en.toString(), en);
    }
    
    public boolean equals(UniProtEvidenceFields bioType) {
    ...
    UniProtEvidenceFields(String value) {
        this.value = value;
    }
    ...
    public static UniProtEvidenceFields fromString(String value) {
