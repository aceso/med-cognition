 ...
 *
 * <a href="http://www.drugbank.ca/documentation">DrugBank Documentation</a>
 * 
 * For example, for Aspirin:
 * 
 * <pre>
 * db.drugbank.findOne({"drugbank-id" : "DB00945"})
 * </pre>
 * 
 * This shows taxonomy and other sections with multiple entries.
 * collection: drugbank in mongodb
 *
 * @author jtanisha-ee
 */
@BioEntity(bioType = BioTypes.COMPOUND)
public class Compound {

    protected static Logger log = LogManager.getLogger(Compound.class);
    ...
    */
    ...
    private String nodeType = BioTypes.COMPOUND.toString();
    ...
    private HashSet<BioRelation> pubmedRelations;

    /**
     * We are setting pubmed articles based on extracting the information from
     * the following type of information in general-references in DrugBank. Some
     * of these are not pubmed. They may be google books for instance. In those cases,
     * we do not populate this field, as there is no way to pull information from
     * google books.
     *
     * "# Smythe MA, Stephens JL, Koerber JM, Mattson JC: A comparison of lepirudin and argatroban
     * outcomes. Clin Appl Thromb Hemost. 2005 Oct;11(4):371-4.
     * \"Pubmed\":http://www.ncbi.nlm.nih.gov/pubmed/16244762\r
     * #Tardy B, Lecompte T, Boelhen F, Tardy-Poncet B, Elalamy I, Morange P, Gruel Y, Wolf M,
     ...
     * Gouault-Heilmann M, Lucke V: Predictive factors for thrombosis and major bleeding in an
     * observational study in 181 patients with heparin-induced thrombocytopenia treated with
     * lepirudin. Blood. 2006 Sep 1;108(5):1492-6. Epub 2006 May 11.
     * \"Pubmed\":http://www.ncbi.nlm.nih.gov/pubmed/16690967\r# Lubenow N, Eichler P, Lietz T,
     * Greinacher A: Lepirudin in patients with heparin-induced thrombocytopenia - results of the
     * third prospective study (HAT-3) and a combined analysis of HAT-1, HAT-2, and HAT-3.
     * J Thromb Haemost. 2005 Nov;3(11):2428-36. \"Pubmed\":http://www.ncbi.nlm.nih.gov/pubmed/16241940\r#
     * Askari AT, Lincoff AM: Antithrombotic Drug Therapy in Cardiovascular Disease. 2009 Oct; pp. 440???.
     * ISBN 9781603272346. \"Google books\":http://books.google.com/books?id=iadLoXoQkWEC&pg=PA440. "
     *
     * @param pubmedList
     */
    public void setPubmed(HashSet<PubMed> pubmedList) {
    ...
    /**
     * Get a list of pubmed publications for this drug. This information was got from
     * drug bank.
     *
     * @return HashSet<PubMed> 
     */
    public HashSet<PubMed> getPubmed() {
        HashSet<PubMed> pubmedList = new HashSet<PubMed>();
        for (BioRelation bioRelation : pubmedRelations) {
...
[
    ...
    /**
     * Get a list of compound groups from DrugBank.
     * 
     * @return List<String> 
     */
    ...
    /**
     * The drug "name" from DrugBank. Eg. "Lepirudin"
     *
     * @return String
     */
  ...
  // private Collection<BioRelation> pathwayInteractions = new HashSet<BioRelation>();
     ...
     * @param message
     */
    public Compound(String cId, String nodeType, String message) {
        this.casId = cId;
   ...
   /**
    ...
    public String toString() {
        return (nodeType + "-" + casId + "-" + compoundPreferredSymbol + "-" + moleculeIdRef);
    }
