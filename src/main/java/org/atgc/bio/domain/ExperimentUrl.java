 ...
 * @author jtanisha-ee
 */
@BioEntity(bioType = BioTypes.EXPERIMENT_URL)
public class ExperimentUrl {

    protected static Logger log = LogManager.getLogger(ExperimentUrl.class);
     ...
     */
    @Indexed (indexName=IndexNames.EXPERIMENT_URL)
    @Taxonomy (rbClass=TaxonomyTypes.EXPERIMENT_URL, rbField=BioFields.URL)
    private String url;
}