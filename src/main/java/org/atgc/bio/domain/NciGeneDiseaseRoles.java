...
public enum NciGeneDiseaseRoles {
    ...
    */
    ...
    private static final Map<String, NciGeneDiseaseRoles> stringToEnum = new HashMap<String, NciGeneDiseaseRoles>();

    static { // init map from constant name to enum constant
        for (NciGeneDiseaseRoles en : values())
            stringToEnum.put(en.toString(), en);
    }

    public boolean equals(NciGeneDiseaseRoles bioType) {
    ...
    NciGeneDiseaseRoles(String value) {
        this.value = value;
    }
    ...
    public static NciGeneDiseaseRoles fromString(String value) {
    ...
    public static NciGeneDiseaseRoles getRoleEnum(String prefixVal) {
        for (String value : stringToEnum.keySet()) {
