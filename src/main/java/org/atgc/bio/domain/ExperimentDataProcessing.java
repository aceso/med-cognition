 ...
 * @author jtanisha-ee
 */
@BioEntity(bioType = BioTypes.EXPERIMENT_DATA_PROCESSING)
public class ExperimentDataProcessing {

    protected static Logger log = LogManager.getLogger(ExperimentDataProcessing.class);
    ...
    /**
     * library in attributeList.
     */
    @Indexed (indexName=IndexNames.EXPERIMENT_DATA_PROCESSING)
    @Taxonomy (rbClass=TaxonomyTypes.EXPERIMENT_DATA_PROCESSING, rbField=BioFields.DATA_PROCESSING)
