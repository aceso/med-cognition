 ...
 * @author jtanisha-ee
 */
@BioEntity(bioType = BioTypes.EXPERIMENT_LIBRARY)
public class ExperimentLibrary {

    protected static Logger log = LogManager.getLogger(ExperimentLibrary.class);
     ...
     */
    @Indexed (indexName=IndexNames.EXPERIMENT_LIBRARY)
    @Taxonomy (rbClass=TaxonomyTypes.EXPERIMENT_LIBRARY, rbField=BioFields.LIBRARY_USED)
