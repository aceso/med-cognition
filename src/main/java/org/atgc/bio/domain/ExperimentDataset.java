 ...
 *
 * The dataset field below is what we are talking about.
 *
        "attributeList" : [
                {
                        "@nameAc" : "MI:0875",
...
public class ExperimentDataset {
     ...
     */
    @Indexed (indexName=IndexNames.EXPERIMENT_DATASET)
    @Taxonomy (rbClass=TaxonomyTypes.EXPERIMENT_DATASET, rbField=BioFields.DATASET)
